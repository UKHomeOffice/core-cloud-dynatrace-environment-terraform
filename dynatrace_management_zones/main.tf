        ...
        content {
          ...
          dynamic "attribute_rule" {
            ...
            content {
              ...
              # Only render propagation flags if true
              azure_to_pgpropagation                           = try(attribute_rule.value.azure_to_pgpropagation, false) ? true : null
              azure_to_service_propagation                     = try(attribute_rule.value.azure_to_service_propagation, false) ? true : null
              custom_device_group_to_custom_device_propagation = try(attribute_rule.value.custom_device_group_to_custom_device_propagation, false) ? true : null
              host_to_pgpropagation                            = try(attribute_rule.value.host_to_pgpropagation, false) ? true : null
              pg_to_host_propagation                           = try(attribute_rule.value.pg_to_host_propagation, false) ? true : null
              pg_to_service_propagation                        = try(attribute_rule.value.pg_to_service_propagation, false) ? true : null
              service_to_host_propagation                      = try(attribute_rule.value.service_to_host_propagation, false) ? true : null
              service_to_pgpropagation                         = try(attribute_rule.value.service_to_pgpropagation, false) ? true : null
