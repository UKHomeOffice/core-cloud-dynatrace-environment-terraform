...
module "metric_stream" {
  ...
  for_each = contains(keys(var.tenant_vars), "metric_stream") ? var.tenat_vars.metric_stream : {}
...
module "firehose_dynatrace" {
  ...
  for_each = contains(keys(var.tenant_vars), "firehose_dynatrace") ? var.tenat_vars.firehose_dynatrace : {}
